...
<nav class="navbar navbar-expand navbar-light " style="background-color:white ;">
  ...
  <div class="collapse navbar-collapse " id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#employeeLoginModal" style="background-color:#c91c1c; border-color:#c91c1c; font-size:medium">
        Employee Login
      </button>
    </ul>  
  </div>
